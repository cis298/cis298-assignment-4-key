...
For an extra 40 points of assignment extra credit you can do the following:
...
You  must also add a section to this README telling me if you decided to attempt the extra credit. If you do not, I will assume that you are not doing it.
